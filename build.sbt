...
ThisBuild / organization := "org.transitAnalytics"
...
lazy val root = (project in file(".")).
  settings(
    ...
    // assembly / mainClass := Some("org.transitAnalytics.MainApp"),
    // assembly / assemblyJarName := "2022SpringScalaIntro.jar",
    assembly / mainClass := Some("org.transitAnalytics.gtfs.GtfsDSApplication"),
    assembly / assemblyJarName := "gtfs.jar",
    assembly / test := {},
