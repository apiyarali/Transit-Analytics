...
import org.transitAnalytics.config.{ConfigUtils, CookieSettings}
import pureconfig.generic.auto._
import com.typesafe.scalalogging.{LazyLogging}

object MainApp extends LazyLogging {

  val COOKIE_CONFIG_PATH="org.transitAnalytics.cookie"
  ...
  def main(args: Array[String]): Unit = {
    implicit val cookie = ConfigUtils.loadAppConfig[CookieSettings](COOKIE_CONFIG_PATH)
